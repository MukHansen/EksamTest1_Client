...
class LoginFacade {
  ...
  addEditHobby = (hobbyName, hobbyDescription) => {
    console.log("Editing hobby", JSON.stringify(hobbyName + hobbyDescription));
    const options = this.makeOptions("PUT", true, hobbyName + hobbyDescription); //True add's the token
