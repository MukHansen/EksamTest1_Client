...
class LoginFacade {
  ...
  addEditHobby = (hobbyName, hobbyDescription) => {
    console.log("Editing hobby", hobbyName + hobbyDescription);
    const options = this.makeOptions("PUT", true, JSON.stringify(hobbyName + hobbyDescription)); //True add's the token
